...
public class create {
	public static void main(String[] args) {
		if (args.length == 0) {
			String errorTXT = "Error: please include one or more file names to compile!\nFor help visit http://javAuto.org/";
			String errorTTL = "Error!"; 
			JOptionPane.showMessageDialog(null,errorTXT,errorTTL,JOptionPane.PLAIN_MESSAGE);
		}
